...
import * as fromModel from '../../../../../my-order/my-order-data.json';
import { AlertService } from '@app/shared/services/alert.service.js';
import { TranslateService } from '@ngx-translate/core';

@Component({
  selector: 'app-payment-filter-modal',
  templateUrl: './payment-filter-modal.page.html',
  styleUrls: ['./payment-filter-modal.page.scss']
})
export class PaymentFilterModalPage implements OnInit {
